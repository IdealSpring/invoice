...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray">
        <span class="l">
            <a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加用户','<c:url value="/jsps/systemmanagement/addadmin.jsp"/>','800')">
...
<script type="text/javascript">
    ...
    function admin_role_add(title,url,w,h){
        layer.open({
            ...
            area:['330px', '275px'],
            content: '<c:url value="/jsps/systemmanagement/addadmin.jsp"/>'
        });
    }
    /*管理员-角色-编辑*/
    ...
    function admin_role_del(obj,id){
        layer.confirm('角色删除须谨慎，确认要删除吗？',function(index){
            var urlValue = '<c:url value="/adminManagement/delectUser"/>?uid=' + id;
            $.ajax({
                type: 'POST',
                url: urlValue,
