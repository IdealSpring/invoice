...
<article class="page-container">
    <form action="<c:url value="/adminManagement/editUser"/>" method="post" class="form form-horizontal" id="submit-id">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>用户名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="hidden" name="uid" value="${adminManagement.uid}">
                <input type="text" class="input-text" value="${adminManagement.name}" name="name">
                <input type="hidden" name="password" value="${adminManagement.password}">
                <input type="hidden" name="email" value="${adminManagement.email}">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <select name="role">
                    <option <c:if test="${adminManagement.role eq 'admin'}">selected="selected"</c:if> value="admin">admin</option>
                    <option <c:if test="${adminManagement.role eq 'super'}">selected="selected"</c:if> value="super">super</option>
                </select>
            </div>
        </div>
        <div class="row cl">
